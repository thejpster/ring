...
mod tests {
    ...
    #[test]
    fn p384_sum_test() {
        sum_test(&p384::PUBLIC_SCALAR_OPS, "src/ec/suite_b/ops/p384-sums.txt");
    }
    ...
    fn p384_difference_test() {
        ...
        difference_test(&p384::COMMON_OPS, GFp_p384_elem_sub,
                        "src/ec/suite_b/ops/p384-sums.txt");
    }
    ...
    fn p384_div_by_2_test() {
        ...
        div_by_2_test(&p384::COMMON_OPS, GFp_p384_elem_div_by_2,
                      "src/ec/suite_b/ops/p384-halves.txt");
    }
    ...
    fn p256_elem_neg_test() {
        ...
        elem_neg_test(&p256::COMMON_OPS, ecp_nistz256_neg,
                      "src/ec/suite_b/ops/p256-negatives.txt");
    }
    ...
    fn p384_elem_neg_test() {
        ...
        elem_neg_test(&p384::COMMON_OPS, GFp_p384_elem_neg,
                      "src/ec/suite_b/ops/p384-negatives.txt");
    }
    ...
    fn elem_neg_test(ops: &CommonOps,
        ...
        test::from_file(file_path, |section, test_case| {
            ...
            // almost-Montgomery reduction, we can't. Instead, unlike the other
            // input files, the input files for this test contain the inverse
            // test vectors explicitly.
    ...
    fn verify_point_equals_affine_point(ops: &PrivateKeyOps, a:
        ...
        let x_aff = ops.common.elem_product(&a_x, &zz_inv);
        let zzz_inv = ops.common.elem_product(&z_inv, &zz_inv);
        let y_aff = ops.common.elem_product(&a_y, &zzz_inv);
